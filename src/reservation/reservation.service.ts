...
export class ReservationService {
    ...
    async createReservation(
        ...
        return DataBaseHelper.createReservation(
            { email, date, time, userName },
            this.reservationRepository,
        );
    }

    async getAllPendingReservations(): Promise<Reservation[]> {
        return DataBaseHelper.getAllPendingReservations(
            this.reservationRepository,
        );
    }
    ...
    async updateReservationsStatus(
        ...
        const updateReservation = await DataBaseHelper.updateReservationsStatus(
            id,
