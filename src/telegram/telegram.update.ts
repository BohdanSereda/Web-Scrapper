...
export class TelegramUpdate {
    ...
    async getRestaurantsContext(ctx: Context): Promise<void> {
        ...
        await ctx.reply(
            'Type city name where you want to see available restaurants',
        );
    }
    ...
    async getWorkingHoursContext(ctx: Context): Promise<void> {
        ...
        await ctx.reply(
            'Type restaurant name where you want to see available working hours',
        );
    }
    ...
    async getReserveContext(ctx: Context): Promise<void> {
        ...
        await ctx.reply(
            'Type restaurant name where you want to reserve a table',
        );
    }
    @On('text')
    async getMessage(
